...
export class EventService {
    getEvents(): Observable<IEvent[]> {
        ...
        setTimeout(() => { subject.next(eventList); subject.complete(); }, 100)
        return subject;
    }
    /* subject is a type of observable and right here we are adding
        data to this observable stream. and we are doing this inside
        of setTimeout to simulate asynchrony. and then after 100ms we 
        will be returning the observable (subject)
    */
    getEvent(id: number) {
